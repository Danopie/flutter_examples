...
class CustomCupertinoPageRoute<T> extends PageRoute<T> {
    ...
    if (route.fullscreenDialog) {
      ...
      return CupertinoPageTransition(
        ...
        child: _CupertinoBackGestureDetector<T>(
          enabledCallback: () {
            final enabled = _isPopGestureEnabled<T>(route);
            return enabled;
          },
          onStartPopGesture: () {
            return _startPopGesture<T>(route);
          },
          child: child,
  ...
  Widget buildTransitions(BuildContext context, Animation<double> animation,
    ...
    return buildPageTransitions<T>(this, context, animation, secondaryAnimation,
        child, Duration(milliseconds: 20));
  }
...
class _CupertinoBackGestureDetector<T> extends StatefulWidget {
  const _CupertinoBackGestureDetector({
    ...
    @required this.child,
    this.touchDelay = const Duration(milliseconds: 0),
...
class CustomCupertinoPageTransitionsBuilder extends PageTransitionsBuilder {
  ...
  Widget buildTransitions<T>(
    ...
    return CustomCupertinoPageRoute.buildPageTransitions<T>(
      route,
      context,
      animation,
      secondaryAnimation,
